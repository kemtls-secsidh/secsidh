...
int steps_guess(long long *bs,long long *gs,long long l)
{
  ...
  /* l=1559: bs=24 gs=16 bench=4574 baseline=9384 */
  if (l <= 1559) { *bs = 24; *gs = 16; return 1; }
  /* l=1567: bs=30 gs=13 bench=4522 baseline=9434 */
  /* l=1571: bs=30 gs=13 bench=4546 baseline=9454 */
  /* l=1579: bs=30 gs=13 bench=4594 baseline=9504 */
  /* l=1583: bs=30 gs=13 bench=4618 baseline=9530 */
  if (l <= 1583) { *bs = 30; *gs = 13; return 1; }
  /* l=1597: bs=22 gs=18 bench=4591 baseline=9614 */
  /* l=1601: bs=22 gs=18 bench=4615 baseline=9632 */
  /* l=1607: bs=22 gs=18 bench=4651 baseline=9672 */
  /* l=1609: bs=22 gs=18 bench=4663 baseline=9682 */
  /* l=1613: bs=22 gs=18 bench=4687 baseline=9708 */
  /* l=1619: bs=22 gs=18 bench=4723 baseline=9744 */
  /* l=1621: bs=22 gs=18 bench=4735 baseline=9756 */
  /* l=1627: bs=22 gs=18 bench=4771 baseline=9794 */
  if (l <= 1627) { *bs = 22; *gs = 18; return 1; }
  /* l=1637: bs=24 gs=17 bench=4718 baseline=9852 */
  /* l=1657: bs=24 gs=17 bench=4838 baseline=9974 */
  /* l=1663: bs=24 gs=17 bench=4874 baseline=10014 */
  /* l=1667: bs=24 gs=17 bench=4898 baseline=10030 */
  /* l=1669: bs=24 gs=17 bench=4910 baseline=10042 */
  if (l <= 1669) { *bs = 24; *gs = 17; return 1; }
  /* l=1693: bs=30 gs=14 bench=4616 baseline=10190 */
  /* l=1697: bs=30 gs=14 bench=4640 baseline=10210 */
  /* l=1699: bs=30 gs=14 bench=4652 baseline=10224 */
  /* l=1709: bs=30 gs=14 bench=4712 baseline=10286 */
  /* l=1721: bs=30 gs=14 bench=4784 baseline=10358 */
  /* l=1723: bs=30 gs=14 bench=4796 baseline=10372 */
  /* l=1733: bs=30 gs=14 bench=4856 baseline=10428 */
  /* l=1741: bs=30 gs=14 bench=4898 baseline=10478 */
  /* l=1747: bs=30 gs=14 bench=4934 baseline=10514 */
  /* l=1753: bs=30 gs=14 bench=4970 baseline=10550 */
  /* l=1759: bs=30 gs=14 bench=5006 baseline=10590 */
  if (l <= 1759) { *bs = 30; *gs = 14; return 1; }
  /* l=1777: bs=22 gs=20 bench=4989 baseline=10694 */
  /* l=1783: bs=22 gs=20 bench=5025 baseline=10734 */
  /* l=1787: bs=22 gs=20 bench=5049 baseline=10758 */
  /* l=1789: bs=22 gs=20 bench=5061 baseline=10770 */
  if (l <= 1789) { *bs = 22; *gs = 20; return 1; }
  /* l=1801: bs=30 gs=15 bench=4739 baseline=10834 */
  /* l=1811: bs=30 gs=15 bench=4793 baseline=10896 */
  /* l=1823: bs=30 gs=15 bench=4865 baseline=10972 */
  /* l=1831: bs=30 gs=15 bench=4913 baseline=11018 */
  /* l=1847: bs=30 gs=15 bench=5009 baseline=11116 */
  /* l=1861: bs=30 gs=15 bench=5087 baseline=11196 */
  /* l=1867: bs=30 gs=15 bench=5123 baseline=11234 */
  /* l=1871: bs=30 gs=15 bench=5147 baseline=11260 */
  /* l=1873: bs=30 gs=15 bench=5159 baseline=11268 */
  /* l=1877: bs=30 gs=15 bench=5183 baseline=11294 */
  /* l=1879: bs=30 gs=15 bench=5195 baseline=11308 */
  /* l=1889: bs=30 gs=15 bench=5255 baseline=11364 */
  /* l=1901: bs=30 gs=15 bench=5327 baseline=11440 */
  /* l=1907: bs=30 gs=15 bench=5363 baseline=11476 */
  /* l=1913: bs=30 gs=15 bench=5399 baseline=11512 */
  if (l <= 1913) { *bs = 30; *gs = 15; return 1; }
  /* l=1931: bs=30 gs=16 bench=4946 baseline=11618 */
  /* l=1933: bs=30 gs=16 bench=4958 baseline=11630 */
  /* l=1949: bs=30 gs=16 bench=5054 baseline=11728 */
  /* l=1951: bs=30 gs=16 bench=5066 baseline=11742 */
  /* l=1973: bs=30 gs=16 bench=5198 baseline=11872 */
  /* l=1979: bs=30 gs=16 bench=5234 baseline=11910 */
  /* l=1987: bs=30 gs=16 bench=5276 baseline=11954 */
  /* l=1993: bs=30 gs=16 bench=5312 baseline=11990 */
  /* l=1997: bs=30 gs=16 bench=5336 baseline=12016 */
  /* l=1999: bs=30 gs=16 bench=5348 baseline=12030 */
  /* l=2003: bs=30 gs=16 bench=5372 baseline=12052 */
  /* l=2011: bs=30 gs=16 bench=5420 baseline=12102 */
  if (l <= 2011) { *bs = 30; *gs = 16; return 1; }
  /* l=2017: bs=24 gs=21 bench=5437 baseline=12134 */
  /* l=2027: bs=24 gs=21 bench=5491 baseline=12198 */
  /* l=2029: bs=24 gs=21 bench=5503 baseline=12210 */
  /* l=2039: bs=24 gs=21 bench=5563 baseline=12272 */
  if (l <= 2039) { *bs = 24; *gs = 21; return 1; }
  /* l=2053: bs=30 gs=17 bench=5217 baseline=12344 */
  /* l=2063: bs=30 gs=17 bench=5277 baseline=12408 */
  /* l=2069: bs=30 gs=17 bench=5313 baseline=12442 */
  /* l=2081: bs=30 gs=17 bench=5385 baseline=12512 */
  /* l=2083: bs=30 gs=17 bench=5397 baseline=12526 */
  /* l=2087: bs=30 gs=17 bench=5421 baseline=12552 */
  /* l=2089: bs=30 gs=17 bench=5433 baseline=12562 */
  /* l=2099: bs=30 gs=17 bench=5493 baseline=12624 */
  /* l=2111: bs=30 gs=17 bench=5559 baseline=12700 */
  /* l=2113: bs=30 gs=17 bench=5571 baseline=12704 */
  /* l=2129: bs=30 gs=17 bench=5667 baseline=12802 */
  /* l=2131: bs=30 gs=17 bench=5679 baseline=12816 */
  /* l=2137: bs=30 gs=17 bench=5715 baseline=12852 */
  /* l=2141: bs=30 gs=17 bench=5739 baseline=12878 */
  /* l=2143: bs=30 gs=17 bench=5751 baseline=12892 */
  /* l=2153: bs=30 gs=17 bench=5811 baseline=12948 */
  if (l <= 2153) { *bs = 30; *gs = 17; return 1; }
  /* l=2161: bs=30 gs=18 bench=5316 baseline=12996 */
  /* l=2179: bs=30 gs=18 bench=5418 baseline=13102 */
  /* l=2203: bs=30 gs=18 bench=5562 baseline=13250 */
  /* l=2207: bs=30 gs=18 bench=5586 baseline=13276 */
  /* l=2213: bs=30 gs=18 bench=5622 baseline=13308 */
  /* l=2221: bs=30 gs=18 bench=5664 baseline=13358 */
  /* l=2237: bs=30 gs=18 bench=5760 baseline=13456 */
  /* l=2239: bs=30 gs=18 bench=5772 baseline=13470 */
  /* l=2243: bs=30 gs=18 bench=5796 baseline=13488 */
  /* l=2251: bs=30 gs=18 bench=5844 baseline=13538 */
  /* l=2267: bs=30 gs=18 bench=5940 baseline=13636 */
  /* l=2269: bs=30 gs=18 bench=5952 baseline=13648 */
  /* l=2273: bs=30 gs=18 bench=5976 baseline=13668 */
  if (l <= 2273) { *bs = 30; *gs = 18; return 1; }
  /* l=2287: bs=30 gs=19 bench=5556 baseline=13758 */
  /* l=2377: bs=30 gs=19 bench=6090 baseline=14292 */
  if (l <= 2377) { *bs = 30; *gs = 19; return 1; }
  return 0;
}
